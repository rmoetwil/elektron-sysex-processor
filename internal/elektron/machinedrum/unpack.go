...
// Should contain Machinedrum-specific unpacking routines—things that are unique to how Machinedrum encodes or structures its payloads beyond the standard MIDI 7-bit packing.
